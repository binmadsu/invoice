...
<h1>
	<h3><i class="fa fa-users"></i> Total Stock List</h3>
</h1>
...
<div class="contentpanel">
		<div class="panel panel-default">
			<div class="panel-heading" >
				...
				<a href="#"><i class="fa fa-caret-right"></i>Total Stock List</a>    
			...
			<table id="tbl_results" class="table mb30">
                  ...
                  <tbody>
			      <?php 
			      foreach($datarows as $row){  $total_qty =@$row['quantity'] + @$row['out_stock_qty'] + @$row['faulty']; ?>
					<tr>
						...
						<td data-title="Title"><a class="btn btn-info btn-xs" ><i class=""><?php echo $total_qty; ?></td>
