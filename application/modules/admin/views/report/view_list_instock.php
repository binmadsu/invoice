...
<h1>
	<h3><i class="fa fa-users"></i> In Stock List</h3>
</h1>
...
<div class="contentpanel">
		<div class="panel panel-default">
			<div class="panel-heading" >
				...
				<a href="#"><i class="fa fa-caret-right"></i>In Stock List</a>    
			...
			<table id="tbl_results" class="table mb30">
			      ...
			      foreach($datarows as $row){ ?>
					<tr>
						...
						<td data-title="Title"><a class="btn btn-info btn-xs" ><i class=""><?php echo @$row['quantity']; ?></td>
						<td data-title="Title"><a class="btn btn-success btn-xs" ><i class=""><?php echo @$row['handover_to']; ?></td>
