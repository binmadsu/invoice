                  ...
                  <div class="form-panel">
						...
						<?php if(!empty($data)) { ?>				
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									//pr($modulelist);
										...
										echo form_dropdown('module_id',$module,$data[0]['m_id'],$js);
									?>
								</div>
							</div>
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $data[0]['c_name']; ?>"  name="module_name" >
                              </div>
                          </div>
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $data[0]['c_controller_name']; ?>"  name="controller_name" >
                              </div>
                          </div>
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $data[0]['c_function']; ?>"  name="method_name" >
                              </div>
                          </div>
						...
						<div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $data[0]['c_description']; ?>"  name="desc" >
                              </div>
                          </div>
